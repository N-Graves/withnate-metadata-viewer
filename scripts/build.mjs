...
const result = await build({
  ...
  outfile: "dist/metadata-viewer.js",
  bundle: true,
  format: "iife",
  target: "es2020",
  platform: "browser",
...
await build({
  ...
  outfile: "dist/metadata-viewer.css",
  bundle: true,
  minify: false,
  banner: { css: banner },
});

const out = result.metafile.outputs["dist/metadata-viewer.js"];
const css = await readFile(new URL("../dist/metadata-viewer.css", import.meta.url));
